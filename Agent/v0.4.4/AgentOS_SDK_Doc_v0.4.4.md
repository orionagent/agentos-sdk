# AgentOS SDK for APK V0.4.4文档

## 📋 版本信息

![SDK](https://img.shields.io/badge/SDK_Version-v0.4.4-blue)
...
```Groovy
dependencies {
        implementation 'com.orionstar.agent:sdk:0.4.4-SNAPSHOT' // 【重要配置】Agent SDK依赖
