# AgentOS SDK v0.4.5 API description
...
**Parameters:**
- `enabled: Boolean` - truedescription，falsedescription（description）
...
```
Set VADdescriptiontimeoutdescription。

**Parameters:**
- `timeout: Long` - timeout in milliseconds，description：1000ms ~ 10000ms，description 3000ms
...
**Parameters:**
- `timeout: Long` - timeout in milliseconds，description：3000ms ~ 30000ms，description 10000ms

**Description：**
- descriptionAIdescription"？"description，description
- description，description
- description1.5description，description
