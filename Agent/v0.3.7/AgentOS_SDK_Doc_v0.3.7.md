# AgentOS SDK for APK V0.3.7文档

## 📋 版本信息

![SDK](https://img.shields.io/badge/SDK_Version-v0.3.7-blue)
...
```Groovy
dependencies {
        implementation 'com.orionstar.agent:sdk:0.3.7-SNAPSHOT' // 【重要配置】Agent SDK依赖
